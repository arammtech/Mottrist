...
using static Mottrist.Service.Features.User.UserValidation;
...
using Mottrist.Service.Features.General.Mapper.Mappers;
...
namespace Mottrist.Service.Features.User
{
    ...
    {
        public Task<Result> AddUserAsync(UserDto userDto)
        {
            throw new NotImplementedException();
        }

        public Task<ChangeUserRoleDto?> ChangeUserRoleAndReturnDtoAsync(int userId, string oldRole, string newRole)
        {
            throw new NotImplementedException();
        }

        public Task<Result> ChangeUserRoleAsync(int userId, string oldRole, string newRole)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<UserDto?> GetAdminUserAsync(int userId)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<List<ApplicationRole>?> GetUserRolesAsync(int userId)
        {
            throw new NotImplementedException();
        }

        public Task<(IEnumerable<UserDto>? Users, int? TotalRecords)> GetUsersAsync(int page, int pageSize = 10, string? role = null, Expression<Func<ApplicationUser, bool>>? filter = null, bool? isLocked = null)
        {
            throw new NotImplementedException();
        }

        public Task<Result> LockUserAsync(int userId)
        {
            throw new NotImplementedException();
        }

        public Task<Result> UnlockUserAsync(int userId)
        {
            throw new NotImplementedException();
        }
